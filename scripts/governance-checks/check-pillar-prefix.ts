...
const VALID_PREFIXES = ['[Pillar 1]', '[Pillar 2]', '[Pillar 3]', '[Pillar 1+2]', '[Pillar 1+3]', '[Pillar 2+3]', '[Pillar 1+2+3]', '[AI]', '[Infra]', '[Cross-cutting]', '[Infra/Pillar 1]', '[Infra/Pillar 2]', '[Infra/Pillar 3]'];
