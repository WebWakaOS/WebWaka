...
--
-- T3 COMPLIANCE: Every user row includes tenant_id.
--   The tenant rows must already exist (Phase 2 must run after Phase 1
--   because of foreign key constraints on tenant_id).
--   However, USR-001 (super_admin) has no workspace tenant — uses platform tenant.
--
...
INSERT OR IGNORE INTO users (
  ...
  kyc_tier, email_verified, phone_verified,
