# Rollback: 0310_education_mlscn_training_institutions_seed
...
## Tables Affected
See `0310_education_mlscn_training_institutions_seed.sql` for the exact table names and IDs inserted.
