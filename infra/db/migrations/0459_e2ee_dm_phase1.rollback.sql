...
ALTER TABLE dm_messages DROP COLUMN ciphertext_v2;
ALTER TABLE dm_messages DROP COLUMN iv_v2;
ALTER TABLE dm_messages DROP COLUMN sender_ephemeral_pubkey;
ALTER TABLE dm_messages DROP COLUMN encryption_version;
