 ...
 * containing INSERT OR IGNORE statements for all 8,809 Nigerian registration areas/wards.
 *
 * USAGE
 * -----
...
const RAW_LGA_TABLE: RawLgaRow[] = [
  ...
  ['place_lga_benue_otukpo','place_state_benue','place_zone_north_central','Otukpo','Oturkpo'],
  ...
  ['place_lga_kogi_kogi','place_state_kogi','place_zone_north_central','Kogi','Koton-Karfe'],
  ...
  ['place_lga_nasarawa_nasarawa_egon','place_state_nasarawa','place_zone_north_central','Nasarawa Egon','Nasarawa-Egon','Nassarawa Egon'],
  ...
  ['place_lga_niger_kontagora','place_state_niger','place_zone_north_central','Kontagora','Kontogur'],
  ...
  ['place_lga_niger_moya','place_state_niger','place_zone_north_central','Moya','Muya'],
  ...
  ['place_lga_plateau_quaan_pan','place_state_plateau','place_zone_north_central','Qua\'an Pan','Quan Pan','Quaan Pan','Qua\'anpa'],
  ...
  ['place_lga_fct_amac','place_state_fct','place_zone_north_central','Abuja Municipal','Municipal Area Council','AMAC','Municipal'],
  ...
  ['place_lga_adamawa_fufure','place_state_adamawa','place_zone_north_east','Fufure','Fufore'],
  ['place_lga_adamawa_ganye','place_state_adamawa','place_zone_north_east','Ganye'],
  ['place_lga_adamawa_gayuk','place_state_adamawa','place_zone_north_east','Gayuk','Guyuk'],
  ['place_lga_adamawa_gombi','place_state_adamawa','place_zone_north_east','Gombi'],
  ['place_lga_adamawa_grie','place_state_adamawa','place_zone_north_east','Grie','Girie'],
  ...
  ['place_lga_adamawa_toungo','place_state_adamawa','place_zone_north_east','Toungo','Teungo'],
  ...
  ['place_lga_bauchi_ganjuwa','place_state_bauchi','place_zone_north_east','Ganjuwa','Gamjuwa'],
  ...
  ['place_lga_gombe_shongom','place_state_gombe','place_zone_north_east','Shongom','Shomgom'],
  ['place_lga_gombe_yamaltu_deba','place_state_gombe','place_zone_north_east','Yamaltu/Deba','Yamaltu Deba','Yalmatu / Deba'],
  // --- Taraba ---
  ...
  ['place_lga_taraba_kumi','place_state_taraba','place_zone_north_east','Kumi','Kurmi'],
  ...
  ['place_lga_yobe_bursari','place_state_yobe','place_zone_north_east','Bursari','Borsari'],
  ...
  ['place_lga_yobe_tarmua','place_state_yobe','place_zone_north_east','Tarmua','Tarmuwa'],
  ...
  ['place_lga_jigawa_kiri_kasama','place_state_jigawa','place_zone_north_west','Kiri Kasama','Kirikasamma','Kirika Samma'],
  ...
  ['place_lga_jigawa_malam_maduri','place_state_jigawa','place_zone_north_west','Malam Maduri','Malam Madori','Malam Mado'],
  ...
  ['place_lga_kano_garun_mallam','place_state_kano','place_zone_north_west','Garun Mallam','Garum Mallam'],
  ...
  ['place_lga_kano_tudun_wada','place_state_kano','place_zone_north_west','Tudun Wada','Tundun Wada'],
  ...
  ['place_lga_katsina_dan_musa','place_state_katsina','place_zone_north_west','Dan Musa','Danmusa'],
  ...
  ['place_lga_katsina_dutsin_ma','place_state_katsina','place_zone_north_west','Dutsin-Ma','Dutsin Ma','Dutsin-M'],
  ...
  ['place_lga_katsina_kankia','place_state_katsina','place_zone_north_west','Kankia','Kankiya'],
  ['place_lga_katsina_katsina','place_state_katsina','place_zone_north_west','Katsina','Katsina (K)'],
  ...
  ['place_lga_kebbi_arewa_dandi','place_state_kebbi','place_zone_north_west','Arewa Dandi','Arewa'],
  ...
  ['place_lga_kebbi_koko_besse','place_state_kebbi','place_zone_north_west','Koko/Besse','Koko Besse','Koko/Bes'],
  ...
  ['place_lga_kebbi_wasagu_danko','place_state_kebbi','place_zone_north_west','Wasagu/Danko','Wasagu Danko','Danko Wasagu'],
  ...
  ['place_lga_sokoto_gwadabawa','place_state_sokoto','place_zone_north_west','Gwadabawa','Gwadabaw'],
  ...
  ['place_lga_sokoto_tambuwal','place_state_sokoto','place_zone_north_west','Tambuwal','Tambawal'],
  ['place_lga_sokoto_tangaza','place_state_sokoto','place_zone_north_west','Tangaza','Tangazar'],
  ['place_lga_sokoto_tureta','place_state_sokoto','place_zone_north_west','Tureta'],
  ['place_lga_sokoto_wamako','place_state_sokoto','place_zone_north_west','Wamako','Wamakko'],
  ...
  ['place_lga_abia_obi_ngwa','place_state_abia','place_zone_south_east','Obi Ngwa','Oboma Ngwa'],
  ...
  // --- Ebonyi ---
  ['place_lga_ebonyi_abakaliki','place_state_ebonyi','place_zone_south_east','Abakaliki','Abakalik'],
  ...
  ['place_lga_enugu_enugu_south','place_state_enugu','place_zone_south_east','Enugu South','EnuguSou'],
  ['place_lga_enugu_ezeagu','place_state_enugu','place_zone_south_east','Ezeagu'],
  ['place_lga_enugu_igbo_etiti','place_state_enugu','place_zone_south_east','Igbo Etiti','Igbo-Eti'],
  ...
  ['place_lga_imo_ezinihitte','place_state_imo','place_zone_south_east','Ezinihitte','Ezinihitte Mbaise'],
  ...
  ['place_lga_imo_ihitte_uboma','place_state_imo','place_zone_south_east','Ihitte/Uboma','Ihitte Uboma','Ihitte-Uboma Isinweke'],
  ...
  ['place_lga_akwaibom_urue_offong','place_state_akwaibom','place_zone_south_south','Urue-Offong/Oruko','Urue Offong Oruko','Urue Offong|Oruko'],
  ...
  ['place_lga_crossriver_calabar_muni','place_state_crossriver','place_zone_south_south','Calabar Municipal','Calabar Municipality'],
  ...
  // --- Delta ---
  ['place_lga_delta_aniocha_north','place_state_delta','place_zone_south_south','Aniocha North','AniochaN'],
  ['place_lga_delta_aniocha_south','place_state_delta','place_zone_south_south','Aniocha South','AniochaS'],
  ...
  ['place_lga_delta_ethiope_east','place_state_delta','place_zone_south_south','Ethiope East','EthiopeE'],
  ['place_lga_delta_ethiope_west','place_state_delta','place_zone_south_south','Ethiope West'],
  ['place_lga_delta_ika_north_east','place_state_delta','place_zone_south_south','Ika North East','IkaNorth'],
  ['place_lga_delta_ika_south','place_state_delta','place_zone_south_south','Ika South','IkaSouth'],
  ['place_lga_delta_isoko_north','place_state_delta','place_zone_south_south','Isoko North','IsokoNor'],
  ['place_lga_delta_isoko_south','place_state_delta','place_zone_south_south','Isoko South','IsokoSou'],
  ...
  ['place_lga_edo_esan_central','place_state_edo','place_zone_south_south','Esan Central','Esan Centtral'],
  ...
  ['place_lga_edo_orhionmwon','place_state_edo','place_zone_south_south','Orhionmwon','Orhionmw'],
  ...
  // --- Rivers ---
  ['place_lga_rivers_abua_odual','place_state_rivers','place_zone_south_south','Abua/Odual','Abua Odual','Abua/Odu'],
  ...
  ['place_lga_rivers_akuku_toru','place_state_rivers','place_zone_south_south','Akuku-Toru','Akuku Toru','Akukutor'],
  ['place_lga_rivers_andoni','place_state_rivers','place_zone_south_south','Andoni','Andoni/Odual'],
  ...
  ['place_lga_rivers_emohua','place_state_rivers','place_zone_south_south','Emohua','Emuoha'],
  ...
  ['place_lga_rivers_ogba_egbema','place_state_rivers','place_zone_south_south','Ogba/Egbema/Ndoni','Ogba Egbema Ndoni','Ogba/Egbema/Andoni'],
  ...
  ['place_lga_rivers_omuma','place_state_rivers','place_zone_south_south','Omuma','Omumma'],
  ...
  ['place_lga_ekiti_gbonyin','place_state_ekiti','place_zone_south_west','Gbonyin','Gboyin'],
  ...
  ['place_lga_lagos_badagry','place_state_lagos','place_zone_south_west','Badagry','Badagary'],
  ...
  ['place_lga_lagos_ifako_ijaiye','place_state_lagos','place_zone_south_west','Ifako-Ijaiye','Ifako Ijaiye','Ifako/Ijaye'],
  ...
  ['place_lga_ogun_imeko_afon','place_state_ogun','place_zone_south_west','Imeko-Afon','Imeko Afon'],
  ...
  ['place_lga_ondo_akoko_north_west','place_state_ondo','place_zone_south_west','Akoko North-West','Akoko North West','AkokoNorthWest'],
  ...
  ['place_lga_ondo_ile_oluji','place_state_ondo','place_zone_south_west','Ile Oluji/Okeigbo','Ile Oluji Okeigbo','IleOluji/Okeigbo'],
  ...
  // --- Osun ---
  ['place_lga_osun_aiyedaade','place_state_osun','place_zone_south_west','Aiyedaade','Ayedaade'],
  ['place_lga_osun_aiyedire','place_state_osun','place_zone_south_west','Aiyedire','Ayedire'],
  ...
  ['place_lga_osun_ife_central','place_state_osun','place_zone_south_west','Ife Central','IfeCentral'],
  ...
  ['place_lga_osun_ilesa_east','place_state_osun','place_zone_south_west','Ilesa East','Ilesha East'],
  ['place_lga_osun_ilesa_west','place_state_osun','place_zone_south_west','Ilesa West','Ilesha West'],
...
-- Total wards: ${matchedRowCount} matched
...
`);
  ...
  if (unmatchedMap.size > 0) {
    ...
    if (fs.existsSync(unmatchedF)) fs.unlinkSync(unmatchedF);
