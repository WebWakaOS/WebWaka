-- Cleaning Service Seed — Pillar 2 Template
...
INSERT INTO website_templates (
  ...
  'cleaning-service-cleaning-service-site', 'cleaning-service',
  'Cleaning Service', 'Professional cleaning — homes, offices & estates across Nigeria',
  'commerce', 2, 'NF-COM-SVC', 'standalone',
  ARRAY['home','services','pricing','contact'],
  'medium', true, true, true, 'NGN',
  ARRAY['CAC Registered','NAFDAC Products','LASEPA Approved','WhatsApp Booking','NDPR Compliant'],
