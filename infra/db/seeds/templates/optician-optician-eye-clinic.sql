-- Optician / Eye Clinic Seed — Pillar 2 Template
...
INSERT INTO website_templates (
  ...
  'optician-optician-eye-clinic', 'optician',
  'Optician / Eye Clinic', 'OOAN-registered optometrist — eyewear, eye tests & vision care',
  'health', 2, 'NF-HLT-SVC', 'standalone',
  ARRAY['home','services','products','contact'],
  'medium', false, true, true, 'NGN',
  ARRAY['OOAN Registered','HEFAMAA Certified','CAC Registered','WhatsApp Appointment','NDPR Compliant'],
