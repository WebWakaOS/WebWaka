-- Tailor / Fashion Atelier Seed — Pillar 2 Template
...
INSERT INTO website_templates (
  ...
  'tailor-atelier-site', 'tailor',
  'Tailor / Fashion Atelier', 'Bespoke African & western styles — made to measure in Nigeria',
  'commerce', 2, 'NF-COM-SVC', 'standalone',
  ARRAY['home','services','gallery','contact'],
  'high', false, true, true, 'NGN',
  ARRAY['CAC Registered','NSITF Member','WhatsApp Orders','NDPR Compliant'],
