-- Security Company Seed — Pillar 2 Template
...
INSERT INTO website_templates (
  ...
  'security-company-guard-service', 'security-company',
  'Security Company', 'NSCDC-licensed guards & surveillance solutions for Nigeria',
  'commerce', 2, 'NF-COM-SVC', 'standalone',
  ARRAY['home','services','contact'],
  'high', false, true, true, 'NGN',
  ARRAY['NSCDC Licensed','CAC Registered','ASIS Nigeria Member','Govt Security Clearance','WhatsApp Enquiry','NDPR Compliant'],
