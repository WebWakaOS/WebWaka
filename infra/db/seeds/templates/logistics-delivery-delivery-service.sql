-- Logistics & Delivery Service Seed — Pillar 2 Template
-- Niche ID: P2-logistics-delivery-delivery-service
...
INSERT INTO website_templates (
  ...
  'logistics-delivery-delivery-service', 'logistics-delivery',
  'Logistics & Delivery Service', 'FRSC-compliant door-to-door delivery — fast, tracked & reliable',
  'transport', 2, 'NF-TRN-SVC', 'standalone',
  ARRAY['home','services','tracking','contact'],
  'high', false, true, true, 'NGN',
  ARRAY['FRSC Compliant','VIO Certified','CAC Registered','WhatsApp Tracking','NDPR Compliant'],
