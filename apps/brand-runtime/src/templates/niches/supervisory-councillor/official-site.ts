...
.sv-hero{text-align:center;padding:2.75rem 0 2rem}
.sv-logo{height:96px;width:96px;object-fit:cover;border-radius:50%;margin-bottom:1.25rem;border:3px solid var(--ww-party-primary)}
.sv-hero h1{font-size:clamp(1.875rem,4.5vw,2.75rem);font-weight:900;line-height:1.15;margin-bottom:.375rem;color:var(--ww-text);letter-spacing:-.02em}
.sv-subtitle{font-size:1.0625rem;font-weight:600;color:var(--ww-party-primary);margin-bottom:.875rem}
.sv-tagline{font-size:1rem;color:var(--ww-text-muted);max-width:40rem;margin:0 auto 1.75rem;line-height:1.6}
.sv-ctas{display:flex;flex-wrap:wrap;gap:.75rem;justify-content:center}
.sv-trust-strip{display:flex;flex-wrap:wrap;gap:.5rem .875rem;justify-content:center;margin:1.5rem 0 0}
.sv-badge{display:inline-flex;align-items:center;gap:.375rem;padding:.3rem .875rem;border-radius:999px;font-size:.78rem;font-weight:700;background:var(--ww-bg-surface);border:1.5px solid var(--ww-party-primary);color:var(--ww-party-primary);white-space:nowrap}
.sv-dot{width:7px;height:7px;border-radius:50%;background:var(--ww-party-primary);flex-shrink:0}
.sv-primary-btn{display:inline-flex;align-items:center;gap:.625rem;padding:.875rem 1.75rem;background:var(--ww-party-primary);color:#fff;border-radius:var(--ww-radius);font-size:1rem;font-weight:700;text-decoration:none;min-height:44px}
.sv-primary-btn:hover{filter:brightness(1.1);text-decoration:none}
.sv-sec-btn{display:inline-flex;align-items:center;gap:.5rem;padding:.75rem 1.5rem;background:transparent;border:2px solid var(--ww-party-primary);color:var(--ww-party-primary);border-radius:var(--ww-radius);font-size:.9375rem;font-weight:600;text-decoration:none;min-height:44px}
.sv-sec-btn:hover{background:var(--ww-party-primary);color:#fff;text-decoration:none}
.sv-wa-btn{display:inline-flex;align-items:center;gap:.625rem;padding:.875rem 1.75rem;background:#25D366;color:#fff;border-radius:var(--ww-radius);font-size:1rem;font-weight:700;text-decoration:none;min-height:44px}
.sv-section{margin-top:2.75rem}
.sv-section-title{font-size:1.375rem;font-weight:700;margin-bottom:1.25rem;color:var(--ww-party-primary)}
.sv-grid{display:grid;gap:1rem;grid-template-columns:repeat(auto-fill,minmax(220px,1fr))}
.sv-card{border:1px solid var(--ww-border);border-radius:var(--ww-radius);padding:1.25rem;background:var(--ww-bg-surface);display:flex;flex-direction:column;gap:.375rem;border-left:4px solid var(--ww-party-primary)}
.sv-card-name{font-size:1rem;font-weight:700;color:var(--ww-text);margin:0}
.sv-card-desc{font-size:.875rem;color:var(--ww-text-muted);line-height:1.55;flex:1;margin:0}
.sv-about-strip{margin-top:2.5rem;padding:1.75rem;background:var(--ww-bg-surface);border:1px solid var(--ww-border);border-radius:var(--ww-radius)}
.sv-about-strip h2{font-size:1.125rem;font-weight:700;margin-bottom:.75rem}
.sv-about-strip p{color:var(--ww-text-muted);line-height:1.75;margin-bottom:1rem;font-size:.9375rem}
.sv-info-strip{margin-top:2.5rem;padding:1.5rem;background:var(--ww-bg-surface);border:1px solid var(--ww-border);border-radius:var(--ww-radius);display:flex;flex-wrap:wrap;gap:1rem 2rem}
.sv-info-item{display:flex;flex-direction:column;gap:.25rem}
.sv-info-label{font-size:.75rem;font-weight:600;color:var(--ww-text-muted);text-transform:uppercase;letter-spacing:.04em}
.sv-info-value{font-size:.9375rem;font-weight:600;color:var(--ww-text)}
.sv-info-value a{color:var(--ww-party-primary)}
.sv-about-hero{text-align:center;padding:2.5rem 0 2rem}
.sv-about-hero h1{font-size:clamp(1.75rem,4vw,2.5rem);font-weight:900;margin-bottom:.375rem;letter-spacing:-.01em}
.sv-cat-badge{display:inline-flex;align-items:center;gap:.4rem;padding:.3rem .9rem;border-radius:999px;font-size:.8rem;font-weight:700;background:var(--ww-party-primary);color:#fff;margin-bottom:1rem}
.sv-body{max-width:44rem;margin:0 auto}
...
.sv-svc-hero{text-align:center;padding:2.5rem 0 2rem}
.sv-svc-hero h1{font-size:clamp(1.75rem,4vw,2.5rem);font-weight:900;margin-bottom:.5rem;letter-spacing:-.01em}
.sv-sub{font-size:.9375rem;color:var(--ww-text-muted);margin-bottom:1.5rem}
.sv-empty{text-align:center;color:var(--ww-text-muted);padding:3rem 1rem;font-size:1rem;line-height:1.8}
.sv-cta-strip{margin-top:2.5rem;padding:2rem 1.5rem;background:var(--ww-bg-surface);border-radius:var(--ww-radius);border:1px solid var(--ww-border);text-align:center}
.sv-cta-strip h3{font-size:1.125rem;font-weight:700;margin-bottom:.5rem}
.sv-cta-strip p{color:var(--ww-text-muted);margin-bottom:1.25rem;font-size:.9375rem}
.sv-contact-hero{text-align:center;padding:2.5rem 0 2rem}
.sv-contact-hero h1{font-size:clamp(1.75rem,4vw,2.5rem);font-weight:900;margin-bottom:.5rem;letter-spacing:-.01em}
.sv-contact-hero p{color:var(--ww-text-muted);max-width:34rem;margin-inline:auto}
.sv-wa-block{margin:1.75rem auto;text-align:center;padding:2rem 1.5rem;background:var(--ww-bg-surface);border:2px solid #25D366;border-radius:var(--ww-radius);max-width:32rem}
.sv-wa-block p{font-size:.9375rem;color:var(--ww-text-muted);margin-bottom:1rem}
.sv-layout{display:grid;gap:2rem;margin-top:1.5rem}
@media(min-width:640px){.sv-layout{grid-template-columns:1fr 1fr}}
.sv-info h2,.sv-form-wrap h2{font-size:1.125rem;font-weight:700;margin-bottom:1rem}
.sv-info p{font-size:.9375rem;color:var(--ww-text-muted);margin-bottom:.625rem;line-height:1.6}
.sv-info a{color:var(--ww-party-primary);font-weight:600}
.sv-form{display:flex;flex-direction:column;gap:.875rem}
.sv-fg{display:flex;flex-direction:column;gap:.375rem}
.sv-fg label{font-size:.875rem;font-weight:600;color:var(--ww-text)}
.sv-input{padding:.625rem .875rem;border:1px solid var(--ww-border);border-radius:var(--ww-radius);font-size:.9375rem;background:var(--ww-bg);color:var(--ww-text);width:100%;min-height:44px;font-family:var(--ww-font)}
.sv-input:focus{outline:2px solid var(--ww-party-primary);outline-offset:1px;border-color:transparent}
.sv-ta{min-height:100px;resize:vertical}
.sv-submit{padding:.875rem 1.5rem;background:var(--ww-party-primary);color:#fff;border:none;border-radius:var(--ww-radius);font-size:1rem;font-weight:700;cursor:pointer;min-height:44px;font-family:var(--ww-font)}
.sv-success{background:#f0fdf4;border:1px solid #86efac;border-radius:var(--ww-radius);padding:1.25rem;text-align:center;color:#166534}
@media(max-width:375px){.sv-ctas{flex-direction:column;align-items:stretch}.sv-primary-btn,.sv-sec-btn,.sv-wa-btn{width:100%;justify-content:center}}
</style>`;
...
export const supervisoryCouncillorOfficialSiteTemplate:WebsiteTemplateContract={
  slug:'supervisory-councillor-official-site',
  version:'1.0.0',
