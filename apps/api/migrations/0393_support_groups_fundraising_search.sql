...
ALTER TABLE search_entries ADD COLUMN IF NOT EXISTS discovery_score INTEGER NOT NULL DEFAULT 0;
ALTER TABLE search_entries ADD COLUMN IF NOT EXISTS state_code TEXT;
ALTER TABLE search_entries ADD COLUMN IF NOT EXISTS lga_code TEXT;
ALTER TABLE search_entries ADD COLUMN IF NOT EXISTS campaign_type TEXT;
ALTER TABLE search_entries ADD COLUMN IF NOT EXISTS group_type TEXT;
