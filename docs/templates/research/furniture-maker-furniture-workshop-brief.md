# Research Brief: Furniture Maker / Workshop
**Niche ID:** P2-furniture-maker-furniture-workshop
**Template Slug:** furniture-maker-furniture-workshop
**Family:** NF-COM-SVC
**NF Priority:** medium
...
The Furniture Maker / Workshop operates within Nigeria's NF-COM-SVC sector. Key business realities include:
...
- **Trust signals:** CAC Registered, SON Quality Standards
...
- **Services:** Custom sofas, beds, wardrobes, dining tables, office furniture, school furniture, kitchen cabinets
...
- Most Nigerian Furniture Maker / Workshop businesses lack a web presence
