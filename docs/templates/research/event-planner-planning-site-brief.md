# Research Brief: Event Planner
**Niche ID:** P2-event-planner-planning-site
**Template Slug:** event-planner-planning-site
**Family:** NF-PRF-SVC
**NF Priority:** high
...
The Event Planner operates within Nigeria's NF-PRF-SVC sector. Key business realities include:
...
- **Trust signals:** CAC Registered, APCON Member, AOCN Certified
...
- **Services:** Weddings, corporate events, birthday parties, naming ceremonies, conferences, vendor coordination, decor
...
- Most Nigerian Event Planner businesses lack a web presence
