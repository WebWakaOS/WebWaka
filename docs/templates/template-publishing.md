...
After submission, the template enters `pending` status. A platform administrator reviews the template for:
...
- **Rejected:** Author is notified with reasons; can resubmit after fixes
