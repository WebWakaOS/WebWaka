...
Phase S05 political/electoral foundation started on 2026-04-21. Batch 1 migration `0305_political_foundation_seed.sql` (mirrored in `apps/api/migrations/`) and standalone seed `infra/db/seed/0006_political_parties.sql` seed the 21 current official INEC political parties as platform-seed organizations, discovery profiles, `political_party_profiles`, search entries, S04 ingestion sidecars, source identity maps, country-level place resolutions, enrichment rows, and provenance links. Source extracts are stored at `infra/db/seed/sources/s05_inec_political_parties_20260421.json` and `infra/db/seed/sources/s05_official_electoral_source_locator_20260421.json`. Validation confirmed 21 party orgs/profiles/vertical profiles/search rows/source links, 2 election-cycle locator rows, 4 term scaffold rows, FTS match for APC, 0 invalid party `primary_place_id` references, and idempotent reruns. S05 remains in progress: polling units, officeholders, politician profiles, assignments, affiliations, candidates, ward reps, constituency offices, campaign offices, and final coverage report are pending. S05 batch 1 reports live at `docs/reports/phase-s05-political-foundation-progress-report-2026-04-21.md` and `docs/reports/phase-s05-political-foundation-source-manifest-2026-04-21.md`.
