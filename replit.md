...
D1 remote deploy: migrations 0307–0313 generated and validated but NOT yet applied to remote Cloudflare D1. Requires `CLOUDFLARE_API_TOKEN` env var with D1 write permissions. Commands documented in S05 deferred items report.
